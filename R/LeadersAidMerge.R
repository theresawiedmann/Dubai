...
leaders <- readRDS("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/PLAD/PathstoPower_individuallevel_v1.0.rds")
...
# Filter and prioritize positions
...
write.csv(leaders,"C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/leaders.csv")

#### Introduce AidData ####

aiddata <- st_read("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/AidData/all_combined_global.gpkg")
aiddata$Donor <- "China"
aiddata$DONOR <- "CHN"
...
dac_disb <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/OECD/DAC2A.csv")
dac_comm <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/OECD/DAC3A.csv")
...
#leaders <- read.csv("C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/leaders.csv")
...
godad <- read.csv("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/GODAD/projectlevel_china_wb.csv")
...
write.csv(mlg_collapsed, "C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/Data_Aid_GODAD.csv")
