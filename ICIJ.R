...
intermediaries <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/nodes-intermediaries.csv") 
intermediaries <- select(intermediaries, -c(status, note, valid_until, sourceID))

entities <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/nodes-entities.csv")
entities <- select(entities, -c(status, sourceID, valid_until, note, service_provider, dorm_date))

addresses <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/nodes-addresses.csv")
addresses <- select(addresses, -c(sourceID, valid_until, note))

officers <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/nodes-officers.csv")
officers <- select(officers, -c(sourceID, valid_until, note))

others <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/nodes-others.csv")
others <- select(others, -c(sourceID, valid_until, note))

relationships <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Raw data/ICIJ/relationships.csv") 
relationships <- select(relationships, -c(status, sourceID))

 # DubaiDataAO <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/DubaiDataOA.csv")
 # DubaiData <- fread("C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/DubaiData.csv")

officers_names <- read.csv("C:/Users/wiedmann4/Dropbox/Aid and corruption/Temp/ICIJmatches_officers_short.csv")
...
write.csv(family_list_df, "C:/Users/wiedmann4/Documents/Aid and corruption/Temp/family_members_list.csv", row.names = FALSE)

csv_filename <- read.csv("C:/Users/wiedmann4/Documents/Aid and corruption/Temp/family_members_list.csv", sep = ";")
...
write.csv(ali_family_network, "C:/Users/wiedmann4/Documents/Aid and corruption/Temp/Ali2.csv")
...
matches_df <- unique(matches_df)
#write.csv(matches_df, "C:/Users/wiedmann4/Documents/Aid and corruption/Temp/ICIJmatches_officers.csv")
officer_matches <- fread("C:/Users/wiedmann4/Documents/Aid and corruption/Temp/ICIJmatches_officers.csv")
